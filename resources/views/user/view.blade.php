                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-lg-2">
                                <div class="admin-blog-image mt-5">
                                    ...
                                    <img src="{{ asset($model->profile_image ? 'uploads/' . $model->profile_image : 'assets/img/avatars/1.png') }}"
                                        alt="Profile" class="grid-image">
                    ...
                    <ul class="nav nav-tabs nav-fill" role="tablist">
                        ...
                        <li class="nav-item">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-justified-wallet-history" aria-controls="navs-justified-messages"
                                aria-selected="false">
