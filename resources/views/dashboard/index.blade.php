                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> {{(new App\Models\User())->profitSalesTransactions('percentageChange')}}%</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span>Sales</span>
                            <h3 class="card-title text-nowrap mb-1">${{(new App\Models\User())->profitSalesTransactions('sales')}}</h3>
